...
from LCatch import collection, user_collection, db, require_power
...
async def redeem_character(client, message):
    ...
    if redeem_code == "LOVEUHONEY":
        await message.reply_text("Madam ka pyar to dekho 🙂😗😌", parse_mode=enums.ParseMode.MARKDOWN)
        return
