...
from LCatch import user_collection, LC
...
@LC.on_message(filters.command("trade"))
...
@LC.on_callback_query(filters.create(lambda _, __, query: query.data.startswith(("confirm_trade_", "cancel_trade_"))))
