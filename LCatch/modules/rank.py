...
import asyncio
import html
from LCatch import app as Client
from LCatch import user_collection, top_global_groups_collection

PHOTO_URL = ["https://files.catbox.moe/9zxcly.jpg"]  
...
async def rank(client, message):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton("CTOP", callback_data="mtop"),
...
async def update_caption(callback_query, caption, active_button):
    buttons = [
        ...
        [
            InlineKeyboardButton("✅ CTOP" if active_button == "mtop" else "MTOP", callback_data="mtop"),
